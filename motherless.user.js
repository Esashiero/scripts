...
(function() {
    ...
    const styles = `
        ...
        #ml-popup-close, #ml-popup-pagelink {
            ...
            z-index: 10001; /* --- BUG FIX: Ensure buttons are on top layer --- */
        }
        #ml-popup-close {
        ...
        /* --- BUG FIX: Make central play button invisible but still clickable --- */
    ...
    const openPopupPlayer = (index) => {
        ...
        if (titleElement) {
            ...
            popupTitle.innerText = titleElement.innerText.trim();
        } else {
